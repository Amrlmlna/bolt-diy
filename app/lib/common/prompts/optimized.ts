...
<artifact_info>
  ...
  - Use \`<bitArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<bitAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<bitArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<bitAction>\` tags with appropriate \`type\` attribute:
