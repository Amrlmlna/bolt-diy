...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-bit-elements-borderColor bg-bit-elements-prompt-background text-bit-elements-textPrimary">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-lg border border-bit-elements-borderColor',
            'bg-bit-elements-prompt-background text-bit-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-bit-elements-focus',
            'transition-all cursor-pointer',
            isProviderDropdownOpen ? 'ring-2 ring-bit-elements-focus' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-bit-elements-textSecondary opacity-75',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-bit-elements-borderColor bg-bit-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'bg-bit-elements-background-depth-2 border border-bit-elements-borderColor',
                    'text-bit-elements-textPrimary placeholder:text-bit-elements-textTertiary',
                    'focus:outline-none focus:ring-2 focus:ring-bit-elements-focus',
                    'transition-all',
                  )}
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-bit-elements-textTertiary" />
                </div>
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:bg-bit-elements-borderColor',
                '[&::-webkit-scrollbar-thumb]:hover:bg-bit-elements-borderColorHover',
                '[&::-webkit-scrollbar-thumb]:rounded-full',
                '[&::-webkit-scrollbar-track]:bg-bit-elements-background-depth-2',
                '[&::-webkit-scrollbar-track]:rounded-full',
                'sm:[&::-webkit-scrollbar]:w-1.5 sm:[&::-webkit-scrollbar]:h-1.5',
                'sm:hover:[&::-webkit-scrollbar-thumb]:bg-bit-elements-borderColor/50',
                'sm:hover:[&::-webkit-scrollbar-thumb:hover]:bg-bit-elements-borderColor',
                'sm:[&::-webkit-scrollbar-track]:bg-transparent',
              )}
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-2 text-sm text-bit-elements-textTertiary">No providers found</div>
              ) : (
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ? 'bg-bit-elements-background-depth-2'
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-bit-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-bit-elements-focus',
            'transition-all cursor-pointer',
            isModelDropdownOpen ? 'ring-2 ring-bit-elements-focus' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-bit-elements-borderColor bg-bit-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
            <div className="px-2 pb-2">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-2 text-sm text-bit-elements-textTertiary">Loading...</div>
              ) : filteredModels.length === 0 ? (
                <div className="px-3 py-2 text-sm text-bit-elements-textTertiary">No models found</div>
              ) : (
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-bit-elements-background-depth-2'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-bit-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
