      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-bit-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-bit-elements-item-backgroundAccent hover:bg-bit-elements-artifacts-backgroundHover"
