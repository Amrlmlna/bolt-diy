      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-bit-elements-textPrimary dark:text-bit-elements-textPrimary-dark'
              : 'text-bit-elements-textSecondary dark:text-bit-elements-textSecondary-dark hover:text-bit-elements-textPrimary dark:hover:text-bit-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-bit-elements-textTertiary dark:text-bit-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
