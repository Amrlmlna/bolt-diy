  ...
  return (
    <motion.button
      ...
      className={classNames(
        'text-bit-elements-textTertiary hover:text-bit-elements-textSecondary dark:text-bit-elements-textTertiary-dark dark:hover:text-bit-elements-textSecondary-dark',
        'rounded-lg hover:bg-bit-elements-background-depth-2 dark:hover:bg-bit-elements-background-depth-3',
