  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-bit-elements-borderColor bg-bit-elements-background-depth-1 text-bit-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-bit-elements-textSecondary', className)} {...props} />;
  },
);
