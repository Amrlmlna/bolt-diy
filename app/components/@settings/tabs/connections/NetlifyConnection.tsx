...
export default function NetlifyConnection() {
          ...
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-bit-elements-background dark:bg-bit-elements-background-depth-2 border border-bit-elements-borderColor dark:border-bit-elements-borderColor hover:border-bit-elements-borderColorActive/70 dark:hover:border-bit-elements-borderColorActive/70 transition-all duration-200">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                <span className="text-sm font-medium text-bit-elements-textPrimary dark:text-bit-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary"
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-bit-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-bit-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-bit-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-bit-elements-background dark:bg-bit-elements-background-depth-1 border border-bit-elements-borderColor dark:border-bit-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                        ...
                        className="flex items-center gap-2 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary hover:bg-bit-elements-item-backgroundActive/10"
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-bit-elements-background dark:bg-bit-elements-background-depth-1 border rounded-lg p-4 transition-all',
                            activeSiteIndex === index
                              ? 'border-bit-elements-item-contentAccent bg-bit-elements-item-backgroundActive/10'
                              : 'border-bit-elements-borderColor hover:border-bit-elements-borderColorActive/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                              <span className="font-medium text-bit-elements-textPrimary dark:text-bit-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-bit-elements-textPrimary dark:text-bit-elements-textPrimary">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-sm flex items-center gap-1 transition-colors text-bit-elements-link-text hover:text-bit-elements-link-textHover dark:text-white dark:hover:text-bit-elements-link-textHover"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <CloudIcon className="h-3 w-3 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-bit-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                                    <span className="text-bit-elements-textSecondary dark:text-bit-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                                      <span className="text-bit-elements-textSecondary dark:text-bit-elements-textSecondary">
                    ...
                    <div className="bg-bit-elements-background dark:bg-bit-elements-background-depth-1 border border-bit-elements-borderColor dark:border-bit-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-bit-elements-background dark:bg-bit-elements-background-depth-1 border border-bit-elements-borderColor dark:border-bit-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-bit-elements-textSecondary dark:text-bit-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-bit-elements-textSecondary dark:text-bit-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                                <span className="text-bit-elements-textSecondary dark:text-bit-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-bit-elements-link-text hover:text-bit-elements-link-textHover dark:text-white dark:hover:text-bit-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="h-3 w-3 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-bit-elements-textPrimary dark:text-bit-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-bit-elements-item-contentAccent dark:text-bit-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-bit-elements-textDestructive dark:text-bit-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-bit-elements-textDestructive dark:text-bit-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-bit-elements-background dark:bg-bit-elements-background border border-bit-elements-borderColor dark:border-bit-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-bit-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>
