...
echo "Starting Bit.DIY update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/stackblitz-labs/bit.diy/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
